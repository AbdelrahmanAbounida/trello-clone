...
// import { BsFileImage, BsXCircle } from "react-icons/bs";
// import { FileIcon, VideoIcon } from "@radix-ui/react-icons";
// import { FcAudioFile } from "react-icons/fc";
// import { LuFolderArchive, LuUploadCloud } from "react-icons/lu";
...
//       return {
//         icon: <BsFileImage size={40} className={ImageColor.fillColor} />,
...
//       return {
//         icon: <FileIcon width={40} className={PdfColor.fillColor} />,
...
//       return {
//         icon: <FcAudioFile size={40} className={AudioColor.fillColor} />,
...
//       return {
//         icon: <VideoIcon width={40} className={VideoColor.fillColor} />,
//         color: VideoColor.bgColor,
//       };
//     }

//     return {
//       icon: <LuFolderArchive size={40} className={OtherColor.fillColor} />,
